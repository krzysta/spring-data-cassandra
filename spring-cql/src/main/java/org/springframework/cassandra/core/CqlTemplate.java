...
public class CqlTemplate extends CassandraAccessor implements CqlOperations {
	...
	@Override
	public ResultSet execute(Batch batch) {
		return doExecute(batch);
	}

	@Override
	public ResultSet execute(Delete delete) {
		return doExecute(delete);
	}

	@Override
	public ResultSet execute(Insert insert) {
		return doExecute(insert);
	}

	@Override
	public ResultSet execute(Truncate truncate) {
		return doExecute(truncate);
	}

	@Override
	public ResultSet execute(Update update) {
